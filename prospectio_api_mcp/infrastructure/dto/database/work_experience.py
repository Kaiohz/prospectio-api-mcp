...
class WorkExperienceDTO(Base):
    ...
    start_date: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)  # YYYY-MM format
    end_date: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)    # YYYY-MM or 'Present'
